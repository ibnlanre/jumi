...
export const propertyVariables: PropertyVariables = {
  '.animate': {
    ...
    '--jumi-backdrop-filter-blur': css('blur', '0'),
    '--jumi-backdrop-filter-brightness': css('brightness', '1'),
    '--jumi-backdrop-filter-contrast': css('contrast', '1'),
    '--jumi-backdrop-filter-drop-shadow': backdropFilterDropShadow,
    ...
    '--jumi-backdrop-filter-grayscale': css('grayscale', '0'),
    '--jumi-backdrop-filter-hue-rotate': css('hue-rotate', '0deg'),
    '--jumi-backdrop-filter-invert': css('invert', '0'),
    '--jumi-backdrop-filter-opacity': css('opacity', '1'),
    '--jumi-backdrop-filter-saturate': css('saturate', '1'),
    '--jumi-backdrop-filter-sepia': css('sepia', '0'),
    '--jumi-backdrop-filter-url': css('url'),
