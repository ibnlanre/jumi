import type { Collection, EffectKeyframes } from '@/types'

export const effectKeyframes: Collection = {
  'accordion': {
  ...
  'arc-bottom-left': {
    '@keyframes jumi-arc-bottom-left': {
      '0%': {
        'opacity': '0',
        'rotate': '90deg',
  ...
  'blinds-in-x': {
    '@keyframes jumi-blinds-in-x': {
      '0%': {
        'clip-path':
          'polygon(0% 0%, 0% 100%, 0% 100%, 0% 0%, 20% 0%, 20% 100%, 20% 100%, 20% 0%, 40% 0%, 40% 100%, 40% 100%, 40% 0%, 60% 0%, 60% 100%, 60% 100%, 60% 0%, 80% 0%, 80% 100%, 80% 100%, 80% 0%)',
      },
      '100%': {
        'clip-path':
          'polygon(0% 0%, 0% 100%, 20% 100%, 20% 0%, 20% 0%, 20% 100%, 40% 100%, 40% 0%, 40% 0%, 40% 100%, 60% 100%, 60% 0%, 60% 0%, 60% 100%, 80% 100%, 80% 0%, 80% 0%, 80% 100%, 100% 100%, 100% 0%)',
      },
    },
  },
  'blinds-in-y': {
    '@keyframes jumi-blinds-in-y': {
      '0%': {
        'clip-path':
          'polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%, 0% 20%, 100% 20%, 100% 20%, 0% 20%, 0% 40%, 100% 40%, 100% 40%, 0% 40%, 0% 60%, 100% 60%, 100% 60%, 0% 60%, 0% 80%, 100% 80%, 100% 80%, 0% 80%)',
      },
      '100%': {
        'clip-path':
          'polygon(0% 0%, 100% 0%, 100% 20%, 0% 20%, 0% 20%, 100% 20%, 100% 40%, 0% 40%, 0% 40%, 100% 40%, 100% 60%, 0% 60%, 0% 60%, 100% 60%, 100% 80%, 0% 80%, 0% 80%, 100% 80%, 100% 100%, 0% 100%)',
      },
    },
  },
  'blinds-out-x': {
    '@keyframes jumi-blinds-out-x': {
      '0%': {
        'clip-path':
          'polygon(0% 0%, 0% 100%, 20% 100%, 20% 0%, 20% 0%, 20% 100%, 40% 100%, 40% 0%, 40% 0%, 40% 100%, 60% 100%, 60% 0%, 60% 0%, 60% 100%, 80% 100%, 80% 0%, 80% 0%, 80% 100%, 100% 100%, 100% 0%)',
      },
  ...
  'hinge-drop': {
    '@keyframes jumi-hinge-drop': {
      ...
      '100%': {
        'opacity': '0',
        'transform': 'translateY(120%) rotate(65deg)',
        'transform-origin': 'top left',
      },
    },
  },
  ...
  'radial-wipe-in': {
    '@keyframes jumi-radial-wipe-in': {
      '0%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 50% 0%, 50% 0%, 50% 0%, 50% 0%, 50% 0%, 50% 0%, 50% 0%, 50% 0%)',
      },
      '12.5%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 0%, 100% 0%, 100% 0%, 100% 0%, 100% 0%, 100% 0%, 100% 0%)',
      },
      '25%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 50%, 100% 50%, 100% 50%, 100% 50%, 100% 50%, 100% 50%)',
      },
      '37.5%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 100% 100%, 100% 100%, 100% 100%, 100% 100%, 100% 100%)',
      },
      '50%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 50% 100%, 50% 100%, 50% 100%, 50% 100%, 50% 100%)',
      },
      '62.5%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 50% 100%, 0% 100%, 0% 100%, 0% 100%, 0% 100%)',
      },
      '75%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 50% 100%, 0% 100%, 0% 50%, 0% 50%, 0% 50%)',
      },
      '87.5%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 50% 100%, 0% 100%, 0% 50%, 0% 0%, 0% 0%)',
      },
      '100%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 50% 100%, 0% 100%, 0% 50%, 0% 0%, 50% 0%)',
      },
    },
  },
  'radial-wipe-out': {
    '@keyframes jumi-radial-wipe-out': {
      '0%': {
        'clip-path':
          'polygon(50% 50%, 50% 0%, 100% 0%, 100% 50%, 100% 100%, 50% 100%, 0% 100%, 0% 50%, 0% 0%, 50% 0%)',
      },
  ...
  'skew-right-down': {
    '@keyframes jumi-skew-right-down': {
      '0%': {
        transform: 'skew(0deg, 0deg)',
      },
      '100%': {
...
} satisfies EffectKeyframes

export const cssEffects: Collection<string> = {}
for (const attribute in effectKeyframes) {
  cssEffects[attribute] = attribute
}
