...
import { containIntrinsicSize } from '@/composition/contain-intrinsic-size'
...
export const keyframeVariables: Record<string, KeyframeVariables> = {
  '.animate': {
    ...
    '--jumi-font-stretch-keyframes': 'none',
...
export const propertyVariables: Record<string, PropertyVariables> = {
  '.animate': {
    ...
    '--jumi-contain-intrinsic-size': containIntrinsicSize,
