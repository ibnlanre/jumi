...
export const keyframeVariables: Record<string, KeyframeVariables> = {
  '.animate': {
    ...
    '--jumi-grid-auto-columns-keyframes': 'none',
    '--jumi-grid-auto-flow-keyframes': 'none',
    '--jumi-grid-auto-rows-keyframes': 'none',
    '--jumi-grid-column-end-keyframes': 'none',
    '--jumi-grid-column-keyframes': 'none',
    '--jumi-grid-column-start-keyframes': 'none',
    '--jumi-grid-keyframes': 'none',
    '--jumi-grid-row-end-keyframes': 'none',
    '--jumi-grid-row-keyframes': 'none',
    '--jumi-grid-row-start-keyframes': 'none',
    '--jumi-grid-template-areas-keyframes': 'none',
    '--jumi-grid-template-columns-keyframes': 'none',
    '--jumi-grid-template-rows-keyframes': 'none',
    '--jumi-hanging-punctuation-keyframes': 'none',
    '--jumi-height-keyframes': 'none',
    '--jumi-hyphenate-character-keyframes': 'none',
    '--jumi-hyphenate-limit-chars-keyframes': 'none',
    '--jumi-hyphens-keyframes': 'none',
    '--jumi-image-orientation-keyframes': 'none',
    '--jumi-image-rendering-keyframes': 'none',
    '--jumi-initial-letter-keyframes': 'none',
    '--jumi-inline-size-keyframes': 'none',
    '--jumi-inset-block-end-keyframes': 'none',
    '--jumi-inset-block-keyframes': 'none',
    '--jumi-inset-block-start-keyframes': 'none',
    '--jumi-inset-inline-end-keyframes': 'none',
    '--jumi-inset-inline-keyframes': 'none',
    '--jumi-inset-inline-start-keyframes': 'none',
    ...
    '--jumi-lighting-color-keyframes': 'none',
    '--jumi-line-break-keyframes': 'none',
    '--jumi-line-clamp-keyframes': 'none',
    '--jumi-line-height-keyframes': 'none',
    '--jumi-list-style-image-keyframes': 'none',
    '--jumi-list-style-keyframes': 'none',
    '--jumi-list-style-position-keyframes': 'none',
    '--jumi-list-style-type-keyframes': 'none',
    '--jumi-margin-block-end-keyframes': 'none',
    '--jumi-margin-block-keyframes': 'none',
    '--jumi-margin-block-start-keyframes': 'none',
    '--jumi-margin-bottom-keyframes': 'none',
    '--jumi-margin-inline-end-keyframes': 'none',
    '--jumi-margin-inline-keyframes': 'none',
    '--jumi-margin-inline-start-keyframes': 'none',
    '--jumi-margin-keyframes': 'none',
    '--jumi-margin-left-keyframes': 'none',
    '--jumi-margin-right-keyframes': 'none',
    '--jumi-margin-top-keyframes': 'none',
