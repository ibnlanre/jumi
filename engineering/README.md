...
| File                                       | Why it is here                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SKILLS.md`                                | operating knowledge for an agent changing Jumi: the nineteen stages and how to run a subset of them, the invariants and what enforces each one, the keyframe authoring rules, the recipes, the release flow, and the traps that have cost time here                                                                                                                                                                                     |
...
| `research/aggregate-offsets.md`            | value-free keyframes fed by element-scoped buckets, measured by three executable books: the reuse, the stop set as identity, the instance as an ownership channel, `inherits: false` as the isolation boundary, and the falsification of sheet-level batching eligibility — with the production representation deliberately undecided                                                                                                   |
| `research/deployment.md`                   | the Vercel contract, and the 2026-09-12 diagnosis of a stale deploy                                                                                                                                                                                                                                                                                                                                                                     |
| `research/rules.md`                        | the standing research rules: the eight failure modes D.3.9–D.3.11 exposed, each with the defect that produced it and the mechanism that now holds it — including the one rule still owed a mechanism, and the two corollaries that catch what the eight do not                                                                                                                                                                          |
