...
| `research/aggregate-offsets.md`            | value-free keyframes fed by element-scoped buckets, measured by two executable books: the reuse, the stop set as identity, the instance as an ownership channel, and `inherits: false` as the isolation boundary — with the production representation deliberately undecided                                                                                                                                                            |
