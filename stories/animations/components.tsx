...
export function AnimationGrid({
  ...
  return (
    <div className='space-y-8'>
      ...
      <div
        className={`grid gap-6 ${gridClasses[columns as keyof typeof gridClasses] || gridClasses[3]}`}
      >
          ...
          >
            {durations.map(duration => (
              <option
                ...
                value={duration}
              >
                {duration.replace('animation-duration-', '')}s
              </option>
            ))}
          </select>
        </div>
          ...
          >
            {delays.map(delay => (
              <option
                ...
                value={delay}
              >
                {delay.replace('animation-delay-', '')}s
              </option>
            ))}
          </select>
        </div>
  ...
  return (
    <div className='mb-12 space-y-6'>
      <div className='space-y-4 text-center'>
        ...
        <p className='max-w-4xl mx-auto text-xl text-gray-600'>{description}</p>
      </div>
